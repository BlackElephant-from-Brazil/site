      ...
      >
        ...
        >
          <svg width="34" height="34" viewBox="0 0 34 34" fill="none" aria-hidden>
            <rect x="4" y="7" width="26" height="22" rx="3" stroke="var(--color-lime)" strokeWidth="2" />
            <path d="M4 13h26" stroke="var(--color-lime)" strokeWidth="2" />
            <path d="M11 4v6M23 4v6" stroke="var(--color-lime)" strokeWidth="2" strokeLinecap="round" />
            <path d="M10 19h4M10 24h6M20 19h4" stroke="var(--color-lime)" strokeWidth="1.5" strokeLinecap="round" />
          </svg>
        </motion.div>
        ...
        <motion.p
          ...
          className="mt-3 text-xs text-[var(--color-lime)]/60"
        >
          {copy.tip}
        </motion.p>
