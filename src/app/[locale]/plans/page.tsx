    ...
    <main className="min-h-screen pt-24 pb-20">
      ...
      <div className="site-container relative z-10">
        ...
        <ScrollReveal className="mb-24">
          <div className="max-w-2xl mx-auto text-center p-8 rounded-2xl bg-[var(--card-background)] border border-[var(--card-border)]">
            <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">{t('additionalUsers.title')}</h3>
        ...
        <ScrollReveal className="mb-24">
          ...
          <div className="rounded-2xl bg-[var(--card-background)] border border-[var(--card-border)] p-6 overflow-hidden">
        ...
        <ScrollReveal className="mb-24">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {[1, 2, 3, 4, 5].map((i) => (
              <details
                key={i}
                className="group p-6 rounded-2xl bg-[var(--card-background)] border border-[var(--card-border)] hover:border-[var(--card-border)] transition-colors"
              >
                <summary className="flex items-center justify-between cursor-pointer list-none">
                  <span className="text-lg font-medium text-[var(--foreground)] pr-4">
                    {t(`faq.q${i}.question`)}
                  </span>
                  <span className="flex-shrink-0 w-8 h-8 rounded-full bg-[var(--background-tertiary)] flex items-center justify-center group-open:rotate-45 transition-transform">
        ...
        {/* CTA */}
        <ScrollReveal>
          <div className="text-center p-12 rounded-3xl bg-gradient-to-br from-[var(--color-brand)]/10 via-[var(--color-gray-900)] to-purple-500/10 border border-[var(--card-border)]">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a
                ...
                className="px-8 py-4 border border-[var(--card-border)] text-[var(--foreground)] font-semibold rounded-xl hover:border-[var(--color-brand)] hover:text-[var(--color-brand)] transition-colors"
              >
                {t('cta.whatsapp')}
              </a>
            </div>
