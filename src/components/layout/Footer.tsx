...
export function Footer({ className }: FooterProps) {
  ...
  const solutionLinks = [
    { label: tFooter('solutionSites'), href: '/plans' },
    { label: tFooter('solutionSystems'), href: '/plans' },
    { label: tFooter('solutionApps'), href: '/plans' },
    { label: tFooter('solutionAI'), href: '/plans' },
  ]

  return (
    <footer
      className={cn('border-t backdrop-blur-xl', className)}
      style={{
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  className="p-2 rounded-lg transition-colors hover:bg-[var(--color-lime)]/10 hover:text-[var(--color-lime)]"
                  style={{ color: 'var(--foreground-muted)' }}
                  aria-label="LinkedIn"
                >
                ...
                <a
                  href="https://github.com/blackelephant-tech"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 rounded-lg transition-colors hover:bg-[var(--color-lime)]/10 hover:text-[var(--color-lime)]"
                  style={{ color: 'var(--foreground-muted)' }}
              ...
              <ul className="space-y-3">
                {solutionLinks.map((link, index) => (
                  <li key={index}>
                    <Link
                      href={link.href}
                      className="text-sm transition-colors hover:text-[var(--color-lime)]"
                      style={{ color: 'var(--foreground-muted)' }}
                    >
                      {link.label}
                    </Link>
