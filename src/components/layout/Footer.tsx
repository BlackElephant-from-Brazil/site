  ...
  return (
    ...
    >
      ...
      <div className="site-container">
        ...
        <div
          className={cn(
            'grid grid-cols-1 gap-12 py-14 sm:grid-cols-2 lg:gap-16 lg:py-20',
            isLandingPage ? 'lg:grid-cols-[2fr_1fr]' : 'lg:grid-cols-[2fr_1fr_1fr]'
          )}
        >
            ...
            {!isLandingPage && (
              <div className="flex items-center gap-1">
                {[
                  ...
                  {
                    href: 'https://www.instagram.com/blackelephantbrasil',
                    label: 'Instagram',
