  ...
  return (
    ...
    >
      <Link href={`/${locale}/portfolio/${item.slug}`} className="block">
        ...
        >
          {/* Hover border glow */}
          <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" style={{ boxShadow: 'inset 0 0 0 1px rgba(31, 111, 107, 0.3)' }} />
          ...
          <div className="relative aspect-[16/10] overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-[var(--color-gray-800)] via-[var(--color-gray-900)] to-[var(--color-black)]">
              <div className="absolute inset-0 opacity-30">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 rounded-full bg-[var(--color-brand)]/20 blur-2xl" />
              </div>
          ...
          {/* Content */}
          <div className="p-6">
            <h3 className="text-xl font-semibold text-[var(--foreground)] mb-2 group-hover:text-[var(--color-brand)] transition-colors duration-300">
              {item.title}
            </h3>
