      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {images.map((image, index) => (
          <motion.button
            ...
            className={`group relative overflow-hidden rounded-xl bg-[var(--color-gray-900)] border border-[var(--color-gray-800)] transition-all duration-300 hover:border-[var(--color-brand)]/50 ${
          ...
          >
            ...
            <div className={`relative ${index === 0 ? 'aspect-[16/9]' : 'aspect-[4/3]'}`}>
              ...
              <div className="absolute inset-0 bg-[var(--color-black)]/0 group-hover:bg-[var(--color-black)]/40 transition-colors duration-300 flex items-center justify-center">
                ...
                >
                  <div className="w-14 h-14 rounded-full bg-[var(--color-brand)] flex items-center justify-center">
